...
| φ-enrichment (genome-wide) | **NOT CONFIRMED** | p = 0.154; genome-wide scan across 9 categories not significant |
| φ-enrichment (direct E-box targets) | **SIGNIFICANT** | p = 0.044, z = −1.63; pre-specified 14-gene set, expression-matched permutation |
| Wee1–Boman temporal bridge | **CONSISTENT** | Wee1 |λ|=0.612, closest gene to 1/φ; direct link to crypt cell division timing |

### Near-phi Gene Table (within 5% of 1/φ ≈ 0.618, computed across 12 mouse tissues, GSE54650)

| Gene | Mean |λ| | Distance from 1/φ | Tier | Tissues | Biological role |
|------|-----------|-------------------|------|---------|-----------------|
| Wee1 | 0.6115 | 0.0065 | Direct E-box target | 12/12 | G2/M checkpoint kinase — circadian gate on cell division |
| Rorc | 0.6248 | 0.0068 | Direct E-box target | 12/12 | ROR-gamma — clock positive feedback + Th17 master regulator |
| Cry1 | 0.6065 | 0.0115 | Core clock | 12/12 | Primary negative feedback repressor — sets circadian period |
| Bhlhe41 | 0.5955 | 0.0225 | Direct E-box target | 12/12 | DEC2 — secondary clock brake; short-sleep mutation P385R |
| Hlf | 0.6421 | 0.0240 | Direct E-box target | 12/12 | PAR-bZip output TF — metabolic timing in liver, kidney, lung |
| Ciart | 0.6593 | 0.0413 | Direct E-box target | 12/12 | CHRONO — BMAL1 co-repressor, clock amplitude damper |

**Permutation results (April 2026, GSE54650 liver expression-matched null, 5,000 iterations):**
- Genome-wide category scan: p = 0.154, not significant
- Pre-specified direct E-box target set (14 genes): **p = 0.044, z = −1.63, significant**
- Combined targets (direct + secondary, 24 genes): p = 0.249, not significant

**Key Wee1–Boman bridge:** Wee1 (|λ|=0.612) is the closest gene to 1/φ and directly gates crypt cell division. Boman's spatial Fibonacci crypt structure is a product of the cell division process whose timing Wee1 controls. This provides a mechanistic link between Boman's spatial Fibonacci observation and the PAR(2) temporal Fibonacci finding. Detailed in Paper M Section 4.4.
...
4. φ-enrichment stated transparently: genome-wide p = 0.154 (not significant); direct E-box target set p = 0.044 (significant, expression-matched)
...
7. Near-phi gene table added (April 2026) with six genes within 5% of 1/φ and biological annotations
8. Wee1–Boman temporal bridge documented (Paper M Section 4.4)

### Organoid Perturbation Summary (GSE157357) — Corrected May 2026

> Prior values (WT: clock 0.723, target 0.331, gap +0.392) retracted — preprocessing artefact (column ordering error, replicates not averaged). Corrected values from Paper O.

| Genotype | Clock |λ| | Target |λ| | Gap | Hierarchy |
|----------|-----------|------------|------|-----------|
| WT | 0.588 | 0.556 | +0.033 | Modest, NS baseline |
| APC-KO | 0.663 | 0.790 | −0.127 | Inverted — target elevation |
| BMAL1-KO | 0.499 | 0.594 | −0.095 | Collapsed — clock reduction |
| Double KO | 0.583 | 0.572 | +0.011 | Partial epistatic restoration |
...
*Updated: April 2026 (Version 4.1 — Direct E-box target phi-enrichment result added: p=0.044, expression-matched permutation, 12 tissues. Near-phi gene table (6 genes within 5% of 1/φ) added. Wee1–Boman temporal bridge documented. Paper M Section 4 cross-reference added.)*  
*Updated: May 2026 (Version 4.2 — GSE157357 organoid values corrected: WT gap +0.392 retracted, corrected to +0.033 (NS). All four conditions updated from Paper O corrected analysis.)*
