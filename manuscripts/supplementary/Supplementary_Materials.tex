...
\begin{itemize}
    \item Web application: \url{https://par2discovery.com}
...
The PAR(2) Discovery Engine (\url{https://par2discovery.com}) provides the following interactive analysis tools:
