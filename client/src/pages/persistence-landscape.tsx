          ...
          <ChapterCard index={0} title="The Data" active={activeChapter === 0}>
            ...
            <div className="flex items-start gap-2 mt-3 bg-amber-900/10 border border-amber-700/25 rounded-md px-3 py-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                <span className="text-amber-400 font-semibold">Eigenvalue cap at |λ| = 0.99.</span> To maintain numerical stability, all computed eigenvalue moduli are hard-capped at 0.99 before ranking and display. A raw value above 0.99 would imply near-unit-root behaviour (effectively non-stationary expression), which the AR(2) stationarity constraint should preclude; values at or very near the cap should be interpreted with caution as they may reflect fitting artefacts rather than genuine high persistence.
              </p>
            </div>
          </ChapterCard>
        </div>
