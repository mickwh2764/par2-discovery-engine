          ...
          <div className="flex items-center justify-between py-2 min-h-[3rem]">
            <div className="flex items-center gap-3" data-testid="dashboard-header">
              ...
              <div className="hidden sm:flex items-center gap-2 px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-xs" data-testid="badge-submission-lock">
                ...
                <span className="text-muted-foreground font-mono text-[10px]">Feb 27, 2026</span>
              </div>
            ...
            <div className="p-8 sm:p-10 space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground max-w-2xl border-l-2 border-emerald-500/50 pl-3">
                  <strong className="text-foreground">Main finding:</strong> Clock genes show consistently higher temporal persistence (|λ| = 0.70) than their downstream targets (|λ| = 0.45) across 10 datasets, 4 species, and 36 comparisons. Select a dataset below to see this for yourself.
                </p>
              </div>
