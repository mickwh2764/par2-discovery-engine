            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              <div className="flex-1 space-y-4">
                ...
                <p className="text-slate-300 leading-relaxed">
                  Independent researcher in mathematical and computational biology, applying dynamical systems theory to gene expression data. Developer of the PAR(2) eigenvalue framework — a period-agnostic method for quantifying temporal persistence in circadian and non-circadian transcriptomes across species, tissues, and disease states.
                </p>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Based in the United Kingdom. Background in military communications and logistics management. This platform represents eight months of full-time independent research into circadian gene-expression dynamics, built entirely on public data from NCBI GEO.
                </p>
                <div className="flex flex-wrap items-center gap-3 pt-2">
                  ...
                  <a href="https://x.com/Michael94211007" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-slate-300 hover:text-white transition-colors">
                  ...
                  <span className="text-slate-600">|</span>
                  <a href="https://github.com/mickwh2764/par2-discovery-engine" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-sm text-slate-300 hover:text-white transition-colors">
                    <ExternalLink size={13} />
                    GitHub
                  </a>
                </div>
