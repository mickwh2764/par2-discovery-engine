...
\textbf{Companion paper.} This work extends a companion study (Whiteside, 2026, ``AR(2) Eigenvalue Modulus as a Measure of Temporal Persistence in Gene Expression'') that validates the AR(2) eigenvalue framework across 35 time series, 4 species, and 12 mouse tissues. The companion paper establishes the eigenvalue hierarchy; the present manuscript decomposes eigenvalues into frequency and damping components to identify genes specifically tuned to 24-hour periodicity.

\vspace{0.3cm}

\textbf{Honest limitations.} We acknowledge that (1) the resonance zone boundaries (20--28h, damping $< 0.5$) are convention-based and sensitivity to threshold choice is warranted; (2) human blood data at 4h resolution yields very few resonance zone genes, likely reflecting statistical power rather than biology; (3) none of the novel predictions have been experimentally validated; (4) the AR(2) model assumes linearity and stationarity; and (5) overdamped genes ($\sim$30--50\% of genes) are excluded from the framework. These limitations are discussed in detail in the manuscript.
